...
;(function () {
    ...
    var initUrl = '/myo2o/shopadmin/getshopinitinfo'
        , registerShopUrl = 'registershop'
        , shopId = common.getQueryString('shopId')
        // var isEdit = shopId ? true : false;
        , isEdit = !!shopId
        , shopInfoUrl = '/myo2o/shopadmin/getshopbyid?shopId=' + shopId
        , editShopUrl = '/myo2o/shopadmin/modifyshop'
        , shoplistUrl = '/myo2o/shopadmin/shoplist'
